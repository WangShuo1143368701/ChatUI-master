...
import com.rance.chatui.EasyRV.EasyRecyclerView;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initWidget() {
        ...
        mDetector = EmotionInputDetector.with(this)
                .setEmotionView(emotionLayout) //表情、更多页面根布局Layout
                .setViewPager(viewpager)       //表情和更多功能是一个Frament，因此放在了ViewPager里面
                .bindToContent(chatList)       //聊天信息列表
                .bindToEditText(editText)      //输入框
                .bindToEmotionButton(emotionButton)  //表情按钮绑定
                .bindToAddButton(emotionAdd)   //add按钮绑定
                .bindToSendButton(emotionSend) //发送按钮绑定
                .bindToVoiceButton(emotionVoice)  //录音按钮绑定
                .bindToVoiceText(voiceText)       //显示“按下说话，放开发送”的textview绑定
                .build();
